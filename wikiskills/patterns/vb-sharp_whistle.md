...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `sharp_whistle` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/sharp_whistle) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (sharp whistle) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
