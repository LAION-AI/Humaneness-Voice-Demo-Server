...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `tsk` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/tsk) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (tsk) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
