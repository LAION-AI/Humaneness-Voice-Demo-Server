...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `yawn` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/yawn) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `yawn` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/yawn) |
| Gruppen-Adapter, volle Dosis — Gruppe `yawn` | `yawn` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/groups_full/yawn) |
| Gruppen-Adapter, 25 % synthetisch — Gruppe `yawn` | `yawn` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/groups_dose25/yawn) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (yawn) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
