...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `smack_one_s_lips` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/smack_one_s_lips) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (smack one s lips) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
