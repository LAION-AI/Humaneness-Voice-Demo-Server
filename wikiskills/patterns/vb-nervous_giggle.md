...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `nervous_giggle` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/nervous_giggle) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `nervous_giggle` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/nervous_giggle) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (nervous giggle) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
