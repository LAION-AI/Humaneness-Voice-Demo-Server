...
> Stand 5. September 2026 · Gruppe `misc_body` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: ja
>
...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `gurgling` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/gurgling) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (gurgling) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
