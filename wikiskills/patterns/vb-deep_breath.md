...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `deep_breath` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/deep_breath) |
| eigener Adapter, nur Erstwahl-Zeilen | `deep_breath` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class_top1/deep_breath) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `deep_breath` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/deep_breath) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (deep breath) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
