...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (snickering giggle) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
