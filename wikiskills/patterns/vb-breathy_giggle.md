...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `breathy_giggle` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/breathy_giggle) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `breathy_giggle` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/breathy_giggle) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (breathy giggle) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
