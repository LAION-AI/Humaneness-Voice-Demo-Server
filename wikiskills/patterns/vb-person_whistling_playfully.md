...
|---|---|---|
| — | für diese Bezeichnung existiert **kein** eigener Adapter | siehe Gruppe `whistle` bzw. [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (person whistling playfully) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
