...
> Stand 5. September 2026 · Gruppe `laugh_soft` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: ja
>
...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `snorting_giggle` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/snorting_giggle) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (snorting giggle) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
