...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `smacks_lips` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/smacks_lips) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (smacks lips) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
