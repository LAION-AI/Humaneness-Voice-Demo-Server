...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `wolf_whistle` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/wolf_whistle) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (wolf whistle) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
