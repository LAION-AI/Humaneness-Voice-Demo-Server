...
> Stand 5. September 2026 · Gruppe `hiccup` im 23-Gruppen-Schema · gemessen · eigener Adapter vorhanden: ja
>
> Gruppen-Mitglieder: `hiccup`, `hiccups`
...
| größengleiche Zufallskontrolle | 0,007 |
| netto über der Zufallskontrolle | -0,007 |
| Genuineness (nur berichtet, kein Tor) | 2,65 |
| WER (Parakeet), absolut | 0,135 |
| WER gepaart gegen die eigene w = 0-Zelle | 0,025 (Grenze +0,104) |
...
Nichts an diesem Etikett funktioniert. Die ehrliche Empfehlung ist, den Laut **nicht über das Burst-Etikett** anzufordern, sondern den Charakter über die Emotionsanweisung zu steuern.
 In derselben Gruppe `hiccup` sind gemessen: `hiccup` — dort lohnt der Blick.
...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `hiccups` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/hiccups) |
| eigener Adapter, nur Erstwahl-Zeilen | `hiccups` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class_top1/hiccups) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `hiccups` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/hiccups) |
| Gruppen-Adapter, volle Dosis — Gruppe `hiccup` | `hiccup` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/groups_full/hiccup) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (hiccups) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
