...
> Stand 5. September 2026 · Gruppe `throat` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: nein
>
> Gruppen-Mitglieder: `ahem`, `clearing_throat`, `clears_throat`, `cough`, `coughing`, `throat_clearing`
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (clearing throat) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
