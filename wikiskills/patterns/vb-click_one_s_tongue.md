...
# vb/click_one_s_tongue

> Stand 5. September 2026 · Gruppe `mouth` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: nein
>
...
|---|---|---|
| — | für diese Bezeichnung existiert **kein** eigener Adapter | siehe Gruppe `mouth` bzw. [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (click one s tongue) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
