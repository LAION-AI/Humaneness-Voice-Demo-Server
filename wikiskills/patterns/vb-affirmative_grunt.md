...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `affirmative_grunt` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/affirmative_grunt) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `affirmative_grunt` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/affirmative_grunt) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (affirmative grunt) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
