...
> Stand 5. September 2026 · Gruppe `growl` im 23-Gruppen-Schema · gemessen · eigener Adapter vorhanden: ja
>
> Gruppen-Mitglieder: `growl`, `snarl`
...
| Trefferquote, **Gruppe** (irgendein Mitglied) | **0,000** — *Gruppe = streng, die Gruppe hat nur diese gemessene Klasse* |
| größengleiche Zufallskontrolle | 0,000 |
| netto über der Zufallskontrolle | 0,000 |
| Genuineness (nur berichtet, kein Tor) | 2,53 |
| WER (Parakeet), absolut | 0,125 |
...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `growl` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/growl) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `growl` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/growl) |
| Gruppen-Adapter, volle Dosis — Gruppe `growl` | `growl` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/groups_full/growl) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (growl) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
