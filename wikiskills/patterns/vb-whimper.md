...
> Stand 5. September 2026 · Gruppe `sob` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: nein
>
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (whimper) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
