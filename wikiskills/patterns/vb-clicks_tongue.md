...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `clicks_tongue` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/clicks_tongue) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (clicks tongue) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
