...
# vb/hand_scratching_head

> Stand 5. September 2026 · Gruppe `misc_body` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: nein
>
> Gruppen-Mitglieder: `burp`, `finger_snaps`, `gurgling`, `hand_scratching_head`, `hand_slaps`, `shivering`, `slap_face`, `sneeze`, `snore`, `snoring`

## Rezept

Diese Bezeichnung wurde **nicht gemessen**, und in ihrer Gruppe `misc_body` ist ebenfalls keine Klasse gemessen. Es gibt dafür **kein belegtes Rezept**.
...
|---|---|---|
| — | für diese Bezeichnung existiert **kein** eigener Adapter | siehe Gruppe `misc_body` bzw. [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (hand scratching head) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
