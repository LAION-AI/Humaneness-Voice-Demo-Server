...
# vb/person_whistling_to_get_attention

> Stand 5. September 2026 · Gruppe `whistle` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: ja
>
...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `person_whistling_to_get_attention` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/person_whistling_to_get_attention) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (person whistling to get attention) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
