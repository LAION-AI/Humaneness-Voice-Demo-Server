...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `kissing_sounds` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/kissing_sounds) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (kissing sounds) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
