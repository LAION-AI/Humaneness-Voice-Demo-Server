...
> Stand 5. September 2026 · Gruppe `growl` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: nein
>
> Gruppen-Mitglieder: `growl`, `snarl`

## Rezept

Diese Bezeichnung wurde **nicht einzeln gemessen**. Sie gehört zur Gruppe `growl`; dort sind gemessen: `growl`.


In dieser Gruppe funktioniert **nichts**: das gemessene Mitglied kommt nicht über 0,000. Für diesen Laut gibt es kein Rezept, das etwas bringt — siehe `vb-growl.md`.
...
Die Gruppe `growl` hilft hier nicht: auch ihre gemessenen Mitglieder (`growl`) kommen nicht über 0,000. Für diesen Laut gibt es derzeit **kein funktionierendes Rezept**; den Charakter über die Emotionsanweisung zu steuern ist der ehrliche Rat.
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (snarl) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
