...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `whispered_mumble` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/whispered_mumble) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (whispered mumble) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
