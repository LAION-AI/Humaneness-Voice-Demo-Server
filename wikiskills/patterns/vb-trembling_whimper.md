...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `trembling_whimper` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/trembling_whimper) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (trembling whimper) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
