...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `lip_smack` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/lip_smack) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (lip smack) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
