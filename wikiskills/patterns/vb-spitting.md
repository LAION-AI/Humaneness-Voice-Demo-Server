...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `spitting` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/spitting) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (spitting) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
