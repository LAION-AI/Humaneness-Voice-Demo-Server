...
> Stand 5. September 2026 · Gruppe `swallow` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: nein
>
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (slurping noises) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
