...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `nervous_gulp` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/nervous_gulp) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (nervous gulp) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
