...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `quiet_sob` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/quiet_sob) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (quiet sob) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
