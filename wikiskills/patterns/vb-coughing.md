...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `coughing` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/coughing) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `coughing` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/coughing) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (coughing) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
