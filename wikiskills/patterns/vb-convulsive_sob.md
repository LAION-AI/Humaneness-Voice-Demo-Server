...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `convulsive_sob` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/convulsive_sob) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (convulsive sob) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
