...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `resonant_hum` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/resonant_hum) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (resonant hum) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
