...
> Stand 5. September 2026 · Gruppe `sob` im 23-Gruppen-Schema · gemessen · eigener Adapter vorhanden: ja
>
...
| größengleiche Zufallskontrolle | 0,018 |
| netto über der Zufallskontrolle | -0,018 |
| Genuineness (nur berichtet, kein Tor) | 2,49 |
| WER (Parakeet), absolut | 0,121 |
...
|---|---|---|
| **eigener Adapter, nachtrainiert** | `sobs` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/per_class/sobs) |
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `sobs` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/sobs) |
| Gruppen-Adapter, volle Dosis — Gruppe `sob` | `sob` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/groups_full/sob) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (sobs) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
