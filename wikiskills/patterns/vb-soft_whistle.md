...
|---|---|---|
| **ausgeliefert** (bisheriger Satz, Rückfallvariante) | `soft_whistle` | [`laion/moss-va-sft3-vocal-burst-lora-adapters`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters/tree/main/adapters/soft_whistle) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (soft whistle) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
