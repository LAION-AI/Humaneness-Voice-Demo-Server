...
> Stand 5. September 2026 · Gruppe `moan` im 23-Gruppen-Schema · **nicht einzeln gemessen** · eigener Adapter vorhanden: nein
>
> Gruppen-Mitglieder: `moan`, `pain_moan`, `pleasure_moan`

## Rezept

Diese Bezeichnung wurde **nicht einzeln gemessen**. Sie gehört zur Gruppe `moan`; dort sind gemessen: `pain_moan`, `pleasure_moan`.


In dieser Gruppe funktioniert **nichts**: das gemessene Mitglied kommt nicht über 0,000. Für diesen Laut gibt es kein Rezept, das etwas bringt — siehe `vb-pain_moan.md`.
...
Die Gruppe `moan` hilft hier nicht: auch ihre gemessenen Mitglieder (`pain_moan`, `pleasure_moan`) kommen nicht über 0,000. Für diesen Laut gibt es derzeit **kein funktionierendes Rezept**; den Charakter über die Emotionsanweisung zu steuern ist der ehrliche Rat.
...
|---|---|---|
| Gruppen-Adapter, volle Dosis — Gruppe `moan` | `moan` | [`laion/moss-va-sft3-vocal-burst-lora-adapters-v2`](https://huggingface.co/laion/moss-va-sft3-vocal-burst-lora-adapters-v2/tree/main/groups_full/moan) |
...
* Der Burst ist **eine eigene Klammer** zwischen den Wörtern — `(clearly amused) … (moan) …`. Innerhalb einer Regieanweisung genannt entsteht **kein** Laut.
