...
| `EMOTION_NAMES` | `{'Pleasure_Ecstasy', 'Pride', 'Concentration', 'Bitterness', 'Confusion', 'Contentment', 'Fear', 'Interest', 'Hope_Enthusiasm_Optimism', 'Jealousy_and_Envy', 'Sadness', 'Sexual_Lust', 'Astonishment_Su …` |
| `GEN_MODE` | `adapter` |
