...
| `EMOTION_NAMES` | `{'Disappointment', 'Malevolence_Malice', 'Embarrassment', 'Elation', 'Sadness', 'Pride', 'Pleasure_Ecstasy', 'Concentration', 'Contentment', 'Doubt', 'Awe', 'Sourness', 'Intoxication_Altered_States_of …` |
| `GEN_MODE` | `adapter` |
