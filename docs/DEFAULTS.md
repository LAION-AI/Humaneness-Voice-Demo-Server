...
| `EMOTION_NAMES` | `{'Thankfulness_Gratitude', 'Infatuation', 'Pleasure_Ecstasy', 'Emotional_Numbness', 'Amusement', 'Contemplation', 'Contentment', 'Jealousy_and_Envy', 'Sexual_Lust', 'Bitterness', 'Affection', 'Hope_En …` |
| `GEN_MODE` | `adapter` |
