...
`emo/Shame` — emotion. Generated from the measured JSON on 2026-09-02 by `code/build_wikiskills.py`; do not edit by hand, edit the generator or the measurements it reads.

Steering vector key `emo:Shame`. Target metric `emo_pct`, baseline 0.534 over 10 prompts.

## Coefficient block

```yaml
attribute: emo/Shame
steering_key: emo:Shame
target_metric: emo_pct
adapter:
  name: sft3_emotion:Shame
  usable: false
  safe_w: null
  strong_w: null
...
|--:|--:|--:|--:|--:|--:|--:|--:|:--|
| 0.25 | 0.620 | -0.040 | -0.85 | 3/10 | -0.028 | -0.083 | -0.008 | yes |
| 0.5 | 0.679 | +0.019 | 0.34 | 5/10 | -0.017 | +0.016 | +0.027 | yes |
| 0.75 | 0.694 | +0.033 | 0.68 | 6/10 | -0.021 | -0.088 | +0.007 | yes |
| 1.0 | 0.705 | +0.044 | 1.08 | 6/10 | +0.011 | +0.200 | +0.014 | yes |
| 1.25 | 0.685 | +0.024 | 0.62 | 5/10 | -0.031 | +0.188 | +0.033 | yes |
| 1.5 | 0.711 | +0.051 | 0.99 | 8/10 | -0.037 | +0.193 | -0.012 | yes |
...
| pair | interaction | t |
|---|--:|--:|
| adapter × steering | +0.460 | 1.81 |
| adapter × guidance | -0.111 | -0.48 |
| steering × guidance | -0.051 | -0.25 |

Target in SD units at each corner of the 2×2×2 (bits are adapter, steering, guidance):

| 000 | 001 | 010 | 011 | 100 | 101 | 110 | 111 |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 2.795 | 2.730 | 2.904 | 2.878 | 2.577 | 2.490 | 3.236 | 3.008 |
...
* Recipes and every Δ in this page: `combination-study/stats/comb_recommendations.json`, key `emo/Shame`.
* Interaction terms: `combination-study/stats/analysis.json`, `t2`.
* Dose ladder: `lora-dose/coefficients.json`, key `emotion/Shame`.
* Layer ranking behind `topK`: `work_vb/tap_rank.json`.
* Steering vectors: `actforensics/vectors/p3_vectors_ext.npz`, row `emo:Shame`.
