...
`emo/Bitterness` — emotion. Generated from the measured JSON on 2026-09-02 by `code/build_wikiskills.py`; do not edit by hand, edit the generator or the measurements it reads.

Steering vector key `emo:Bitterness`. Target metric `emo_pct`, baseline 0.451 over 10 prompts.

## Coefficient block

```yaml
attribute: emo/Bitterness
steering_key: emo:Bitterness
target_metric: emo_pct
adapter:
  name: sft3_emotion:Bitterness
  usable: false
  safe_w: null
  strong_w: null
...
|--:|--:|--:|--:|--:|--:|--:|--:|:--|
| 0.25 | 0.395 | +0.019 | 0.49 | 5/10 | -0.061 | +0.090 | +0.062 | yes |
| 0.5 | 0.390 | +0.014 | 0.40 | 6/10 | -0.049 | +0.204 | -0.025 | yes |
| 0.75 | 0.338 | -0.039 | -0.80 | 4/10 | -0.056 | +0.208 | +0.043 | yes |
| 1.0 | 0.422 | +0.046 | 1.01 | 6/10 | -0.062 | +0.193 | +0.012 | yes |
| 1.25 | 0.433 | +0.057 | 1.81 | 8/10 | -0.026 | +0.129 | -0.031 | yes |
| 1.5 | 0.395 | +0.019 | 1.06 | 5/10 | -0.058 | +0.086 | +0.021 | yes |
...
| pair | interaction | t |
|---|--:|--:|
| adapter × steering | +0.200 | 0.99 |
| adapter × guidance | +0.188 | 0.83 |
| steering × guidance | +0.176 | 1.45 |

Target in SD units at each corner of the 2×2×2 (bits are adapter, steering, guidance):

| 000 | 001 | 010 | 011 | 100 | 101 | 110 | 111 |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 1.841 | 1.665 | 1.629 | 1.522 | 1.820 | 1.726 | 1.702 | 1.889 |
...
* Recipes and every Δ in this page: `combination-study/stats/comb_recommendations.json`, key `emo/Bitterness`.
* Interaction terms: `combination-study/stats/analysis.json`, `t2`.
* Dose ladder: `lora-dose/coefficients.json`, key `emotion/Bitterness`.
* Layer ranking behind `topK`: `work_vb/tap_rank.json`.
* Steering vectors: `actforensics/vectors/p3_vectors_ext.npz`, row `emo:Bitterness`.
